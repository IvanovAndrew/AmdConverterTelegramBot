...
public interface IBankParserFactory
{
    ...
    RateParserBase CreateParserFromType(Type type);
}
...
public class BankParserFactory : IBankParserFactory
{
    ...
    public BankParserFactory(CurrencyParser currencyParser, CultureInfo cultureInfo)
    {
    ...
    public RateParserBase CreateParserFromType(Type type)
    {
        return (RateParserBase) Activator.CreateInstance(type, _currencyParser, _cultureInfo);
    }
